...
try {
    ...
    $mail->addAddress( $_SESSION['emailto'], $_SESSION['fname']);  // This email is where you want to send the email
    ...
    $mail->Subject = $_SESSION['subject'];       //subject line of email
    $mail->Body = $_SESSION['body'];   //Email body
    $mail->AltBody = '';   //Alternate body of email
    
    $mail->send();
    echo "Email message sent.";
    header("Location: ../18.contact-page.php");
} catch (Exception $e) {
